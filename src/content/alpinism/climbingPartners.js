...
/* pokud chcete přidat dalšího, tak:
  - zkopírovat objekt {} a přidat na konec (do angličtiny i češtiny)
  - prepsat jmeno a popisek 
  - do images slozky nahrat fotku - jeji nazev musi zacinat na `c-partners_` - to co nasleduje za `c-partners_`, pak dat do imageTitle */

export const climbingPartnersCz = [
  {
    imageTitle: "baca",
  ...
  },
  {
    ...
    description: "Motorová myš do spár a Freerider do Yosemit.",
  },
  {
    imageTitle: "ricardo",
...
export const Cz1 = () => {
  return (
    <>
      <p>
        Čím jsem starší, tím víc mi nejde ani tak o to, co a kde lezu, ale s
        kým. Lezení vděčím za spoustu kamarádů. Ne všechny je možné zmínit, ale
        s některými mne spojují horské zážitky, které jsou intenzivnější než ze
        skal. Výjimkou je pískovcové lezení, to jsou hory v malém a zážitky
        nezřídka velké…
      </p>
    </>
  );
...
export const Cz2 = () => {
  return (
    <>
      <p>
        Začátky lezení, to jsou kamarádi z horolezeckého oddílu HO Lokomotiva –
        Ingstav Brno jako <b>Vojta Dvořák "Watt"</b>,{" "}
        <b>Radek Lienerth "Zoban"</b>, <b>Petr Holzer "Hop"</b>, kteří mne vzali
        v horách na lano, když jsem se lezecky rozkoukával.
      </p>
      <p>
        Jako sociolog dbám na genderovou rovnost a nezmínit spolulezkyně by bylo
        minimálně nekorektní. Takže last but not least :
      </p>
    </>
  );
};

export const climbingPartnersFCz = [
  {
...
export const climbingPartnersEn = [
  {
    imageTitle: "baca",
    name: "Pavel Vrtík „Bača“",
    description:
  ...
  },
  {
    ...
    name: "Honza Doudlebský „Doudlebák“ ",
    description:
      "The best ice climber I've ever met. Ten days of climbing together in the wall of Pike 4810 in Kyrgyzstan is one of the wildest climbing experiences I have had. Our first ascent of Robinson Crusoe to the Cima Grande in the Dolomites is one of the most mentally demanding routes in the area.",
  },
  {
    imageTitle: "dzony",
    name: "Pavel Jonák  „Džony“",
...
export const climbingPartnersFEn = [
  {
    name: "Monika Podbraná / Janáková",
    description:
  ...
  },
  {
    name: "Míša Boudová",
    description:
      "Together we climbed one of the most overhanging routes in the High Tatras and watched foxes where they give a good night.",
  },
  {
    name: "Kateřina Gajdová „Kača“",
    description:
